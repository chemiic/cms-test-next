...
const TableHeader = () => {
    ...
    const onAdd: MouseEventHandler<HTMLButtonElement> = (e)=>{onOpen('addModal')}

    return (
        <div className="flex justify-between bg-white p-3 rounded-t-xl">
            <div className="flex gap-2">
                <button className="flex items-center px-5 gap-2 rounded-md border-solid border border-[#C6C2DE] hover:border-[#6D5BD0] transition">
                ...
                <form className="bg-[#f4f2ff] max-w-lg flex items-center gap-2 px-2.5 rounded-md">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <input className="bg-transparent w-[25vw] h-[40] outline-none text-[$6e6893]" placeholder={'Поиск' +
                        ' по наименованию и категории'}/>
                </form>
            </div>
